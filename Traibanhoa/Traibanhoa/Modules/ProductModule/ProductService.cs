...
namespace Traibanhoa.Modules.ProductModule
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository productRepository, ITypeRepository typeRepository)
        {
        ...
        public async Task<Boolean> AddNewProduct(CreateUsertRequest productRequest)
        {
